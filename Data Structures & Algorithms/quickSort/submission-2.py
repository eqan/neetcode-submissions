...
class Solution:
    ...
    def quickSortHelper(self, pairs, s, e):
        ...
        self.quickSortHelper(pairs, s, left-1) # Sorting from start to before pivot(which is now left)
        self.quickSortHelper(pairs, left+1, e) # Sorting from left to the end of the array
